...
Serial.printf("adc0Voltage: %f, adc1Voltage: %f, adc2Voltage: %f, adc3Voltage: %f\n(%d)\n",
              myAdc.get_voltage(0), myAdc.get_voltage(1), myAdc.get_voltage(2), myAdc.get_voltage(3), t2 - t1);
